/**
* This program takes six numbers that the user inputs and displays them as well as their sums.
* @author Rithwik Seth
*/
...
public class Unit1Lab2
{
  public static void main( String [] args )
  {
    ...
    // Output using System.out.println() and creates desgin using spaces and tabs
    System.out.println( "\n\n" );
